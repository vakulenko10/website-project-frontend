  ...
  return (
    <header className="relative h-[100svh] w-full flex items-center justify-center text-text7">
        ...
        <div className="relative text-center space-y-4 z-10 font-extraBold w-full">
            ...
            <button className="mt-5 px-8 py-2 border-text1 border-4 text-text1 rounded-[10px] shadow-md font-thin text-base font-display transition-all duration-300 ease-in-out transform hover:scale-105 hover:bg-opacity-80 hover:bg-text1 hover:text-white"  style={{
        ...
        <div className="absolute top-1/3 left-[1%] xsm:left-[10%] sm:left-1/4 transform -translate-y-1/2 rotate-[20deg] z-0">
            <img src="https://res.cloudinary.com/dujdz2jbl/image/upload/v1731165063/frontend/fmw7wiitxwsxbs19e7cn.png" draggable="false" alt="Product 1" className="w-auto h-[8rem] lg:h-[10rem]" />
        </div>
        <div className="absolute top-1/3 right-[1%]  xsm:right-[10%] sm:right-1/4 transform -translate-y-1/2 rotate-[-20deg] z-0">
            <img src="https://res.cloudinary.com/dujdz2jbl/image/upload/v1731165063/frontend/q3ucarl3d7tdeulur45z.png" draggable="false" alt="Product 2" className="w-auto h-[8rem] lg:h-[10rem]" />
        </div>
        <div className="absolute top-1/2 right-1/2 transform -translate-y-2/3 translate-x-1/2 z-0">
            <img src="https://res.cloudinary.com/dujdz2jbl/image/upload/v1731165063/frontend/r7v2esy7g4tkyvm7be6c.png" draggable="false" alt="Product 3" className="w-auto h-[12rem] lg:h-[13rem]" />
            <span className=" text-text1 font-serif z-10 absolute top-1/2 right-1/2 -translate-y-2/3 lg:top-1/3 lg:-translate-y-[-0%] translate-x-1/2 text-6xl lg:text-[5rem]" >handmade</span>
        </div>
        </div>
        </div>
        </Container>
