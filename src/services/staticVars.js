...
export const highLightProducts = [
 ...
 export const testimonialsData = [
  ...
  export const links = [
    ...
    { label: 'Etsy', href: "https://www.etsy.com/", icon: <FaEtsy fontSize="2rem" />, img: 'https://res.cloudinary.com/dujdz2jbl/image/upload/v1733492442/frontend/czuhc3yalbh4pahx30eg.jpg' },
    { label: 'Shop', href: "/shop", icon: <GiShoppingCart fontSize="2rem" /> , img: 'https://res.cloudinary.com/dujdz2jbl/image/upload/v1733492474/frontend/msnfvxekykx96auqsjpv.jpg' },
  ];
